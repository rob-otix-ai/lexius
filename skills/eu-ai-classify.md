...
3. Call the API or use the MCP tool `legalai_classify_system` with the gathered signals and description.
...
6. If the system is classified as high-risk, offer to run `/eu-ai-compliance` for a full obligations checklist.
